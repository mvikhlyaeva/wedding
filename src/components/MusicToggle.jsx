...
export default function MusicToggle() {
  ...
  return (
    <motion.button
      onClick={toggle}
      className="fixed bottom-5 right-5 md:bottom-7 md:right-7 z-50 flex items-center gap-2.5 pl-3 pr-4 py-2.5 rounded-full bg-[#243329]/85 backdrop-blur-md border border-white/10 hover:border-[#bfb097]/50 text-white shadow-[0_8px_30px_rgba(0,0,0,0.25)] transition-colors duration-300 group"
    ...
    >
      {/* Icon */}
      <span className="relative w-7 h-7 flex items-center justify-center rounded-full bg-[#bfb097]/15 group-hover:bg-[#bfb097]/25 transition-colors duration-300">
          ...
          {playing ? (
            ...
            >
              {[0, 1, 2, 3].map((i) => (
                <motion.span
                  key={i}
                  className="w-[2.5px] rounded-full bg-[#bfb097]"
