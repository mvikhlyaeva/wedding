    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          {/* Panel */}
          <motion.div
            className="relative z-10 w-full max-w-2xl max-h-full bg-[#f9f4e8] flex flex-col overflow-hidden"
          ...
          >
            {/* Header */}
            <div className="relative flex items-start justify-between px-6 md:px-10 pt-7 md:pt-9 pb-5 border-b border-[#9c8e78]/20 flex-shrink-0 bg-[#f9f4e8] z-10">
              <div>
                <span className="font-sans text-[10px] tracking-[0.35em] uppercase text-[#9c8e78] block mb-2">
                  Lookbook
                </span>
              ...
              <button
                onClick={onClose}
                className="text-[#243329] hover:text-[#9c8e78] transition-colors duration-300 p-1 -mt-1"
                aria-label="Закрыть"
              >
            ...
            <div className="px-6 md:px-10 pt-6 md:pt-8 pb-2 flex-shrink-0">
              <p className="font-serif text-[1rem] md:text-[1.1rem] text-[#5a635a] leading-relaxed">
            ...
            <div className="overflow-y-auto px-6 md:px-10 py-8 md:py-10 space-y-8 md:space-y-12">
              {lookbook.map((item, i) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <span className="font-serif italic text-[#9c8e78] text-[1.05rem]">
                      {String(i + 1).padStart(2, '0')}
                    </span>
                    <span className="block w-10 h-px bg-[#9c8e78]/40" />
                    <span className="font-sans text-[10px] tracking-[0.3em] uppercase text-[#9c8e78]">
                      палитра
                    </span>
                  </div>
                  ...
                  <div className="relative w-full bg-[#ede7d9] overflow-hidden">
                    ...
                    <div
                      data-ph
                      className="hidden absolute inset-0 items-center justify-center aspect-[3/4] text-[#9c8e78]/50 font-sans text-[11px] tracking-[0.25em] uppercase text-center px-6"
                    >
                      lookbook-{i + 1}.jpg<br />
              ...
              <div className="text-center pt-4">
                <span className="block w-10 h-px bg-[#9c8e78]/40 mx-auto mb-5" />
                <p className="font-serif text-[0.95rem] md:text-[1.05rem] text-[#5a635a] leading-relaxed">
